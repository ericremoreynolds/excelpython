...
#If VBA7 Then
	#If win64 Then
		...
		Declare PtrSafe Function XLPyDLLNDims Lib "xlpython64-2.0.9.dll" (ByRef src As Variant, ByRef dims As Long, ByRef transpose As Boolean, ByRef dest As Variant) As Long
	#Else
		...
		Private Declare PtrSafe Function XLPyDLLNDims Lib "xlpython32-2.0.9.dll" (ByRef src As Variant, ByRef dims As Long, ByRef transpose As Boolean, ByRef dest As Variant) As Long
	#End If
...
#Else
	#If win64 Then
		...
		Declare Function XLPyDLLNDims Lib "xlpython64-2.0.9.dll" (ByRef src As Variant, ByRef dims As Long, ByRef transpose As Boolean, ByRef dest As Variant) As Long
	#Else
		Private Const XLPyDLLName As String = "xlpython32-2.0.9.dll"
		...
		Private Declare Function XLPyDLLNDims Lib "xlpython32-2.0.9.dll" (ByRef src As Variant, ByRef dims As Long, ByRef transpose As Boolean, ByRef dest As Variant) As Long
	#End If
